...
export default function ContactForm() {
  return (
    <>
      <div className="flex justify-between flex-col xl:flex-row my-10 py-10 px-6 md:px-20">
        <div className="flex-1 mr-0 xl:mr-10">
          <h2 className="text-3xl mb-6 font-semibold leading-snug tracking-wider">Contact Form</h2>
          <form action="">
